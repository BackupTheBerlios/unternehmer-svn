...
sub adminlogin {
  ...
  $form->{title} = qq|Unternehmer $form->{version} |.$locale->text('Administration');
...
<a href="http://unternehmer.berlios.de"><img src="image/unternehmer.png" border=0></a>
...
<a href=http://unternehmer.berlios.de>Unternehmer |.$locale->text('website').qq|</a>
...
sub add_user {
  ...
  $form->{title} = "Unternehmer ".$locale->text('Administration')." / ".$locale->text('Add User');
  ...
  if (-f "css/unternehmer.css") {
    $myconfig->{stylesheet} = "unternehmer.css";
  }
...
sub edit {
  ...
  $form->{title} = "Unternehmer ".$locale->text('Administration')." / ".$locale->text('Edit User');
  $form->{edit} = 1;
...
# type=submit $locale->text('Oracle Database Administration')
  ...
  $form->{title} = "Unternehmer ".$locale->text('Administration');
...
<table border=0 width=100%>
  <tr class=listheading>
    <th>Unternehmer |.$locale->text('Login').qq|</th>
  </tr>
  <tr>
    <td>
      <table>
...
sub form_header {
  ...
  #eingefuegt um als default dieses format zu haben
  $myconfig->{dateformat} = "dd.mm.yy" unless $myconfig->{dateformat};
  ...
  #eingefuegt um im adminbereich default Sprache=German zu haben
  $myconfig->{countrycode} = "de" unless $myconfig->{countrycode};
  ...
  @allhtml = reverse grep !/Deutsch/, @allhtml;
  push @allhtml, 'Deutsch';
  ...
  $myconfig->{printer} = "lpr" unless $myconfig->{printer};
...
<table width=100% border=0>
  <tr class=listheading>
  	<th colspan=2><center><h2>$form->{title}</h2></center></th>
  </tr>
  <tr class=listheading>
    	<th colspan=2><h3>|.$locale->text('Login settings').qq|</h3></th>
  </tr> 
  <tr>
    <td>
    <table border=0>
  	<tr>
   	  <th align=right>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|.$locale->text('Login name').qq|</th>
    	  <td><input name=login size=42 value="$myconfig->{login}"></td>
  	</tr>
        <tr>
    	  <th align=right>|.$locale->text('Password').qq|</th>
    	  <td align=right><input type=password name=password size=42 value=$myconfig->{password}></td>
  ...
  <tr class=listheading>
    	<th colspan=2><h3>|.$locale->text('Personal User settings').qq|</h3></th>
  </tr>
  ...
  <td>
	...
	<tr valign=top>
	  ...
	  <td><input name=steuernummer size=42 value="$myconfig->{steuernummer}"></td>
	</tr>
        <tr valign=top>
	  <th align=right>|.$locale->text('Ust-IDNr').qq|</th>
	  <td><input name=ustid size=42 value="$myconfig->{ustid}"></td>
	</tr>
        <tr valign=top>
	  <th align=right>|.$locale->text('DUNS-Nr').qq|</th>
	  <td><input name=duns size=42 value="$myconfig->{duns}"></td>
	</tr>
      </table>
    </td>
    <td>
  ...
  <tr class=listheading>
    <th colspan=2><h3>|.$locale->text('Database').qq|</h3></th>
  </tr>|;
  ...
  <tr>
	...
	$form->{Pg_dbhost} = "localhost" unless $form->{Pg_dbhost};
    print qq|
	...
	<tr>|;
    	...
    	$form->{Pg_dbport} = "5432" unless $form->{Pg_dbport};

      print qq|
	  <th align=right>|.$locale->text('Dataset').qq|</th>
	  <td><input name=Pg_dbname size=30 value=$form->{Pg_dbname}></td>
	  <th align=right>|.$locale->text('Port').qq|</th>
	  <td><input name=Pg_dbport size=15 maxlength=5 value=$form->{Pg_dbport}></td>
	</tr>
	<tr>
	  <th align=right>|.$locale->text('User').qq|</th>
	  <td><input name="${item}_dbuser" size=30 value=$form->{"${item}_dbuser"}></td>
	  <th align=right>|.$locale->text('Password').qq|</th>
	  <td><input name="${item}_dbpasswd" type=password size=15 value=$form->{"${item}_dbpasswd"}></td>
	</tr>|;
...
|;
  ...
  print qq|
  <tr class=listheading>
    <th colspan=2><h3>|.$locale->text('Access Control').qq|</h3></th>
  </tr>
  <tr>
...
sub change_admin_password {
  ...
  $form->{title} = qq|Unternehmer |.$locale->text('Administration')." / ".$locale->text('Change Admin Password');
...
sub dbselect_source {
 ...
 $form->{title} = "Unternehmer / ".$locale->text('Database Administration');
...
sub update_dataset {
  ...
  $form->{title} = "Unternehmer ".$locale->text('Database Administration')." / ".$locale->text('Update Dataset');
...
sub create_dataset {
  ...
  $form->{title} = "Unternehmer ".$locale->text('Database Administration')." / ".$locale->text('Create Dataset');
...
sub delete_dataset {
  ...
  $form->{title} = "Unternehmer ".$locale->text('Database Administration')." / ".$locale->text('Delete Dataset');
